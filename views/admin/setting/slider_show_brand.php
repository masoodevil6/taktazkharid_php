...
<div class="form_nav" style="display: block; width: 100%;" >
    ...
    <div class="form_slider">
        ...
        <div class="item_option">
            ...
            <select class="select_parent_category yekan fontlg" name="category" onchange="change_parent_step2_search(this)">
        ...
        <div class="item_option">
            ...
            <select class="select_parent_category yekan fontlg" name="brand" onchange="check_exist_pic()">
                <option value="0">
                    انتخاب کنید
                </option>
                <?php
                foreach ($step4 as $parent){
                    ?>
    ...
    <script>
        ...
        function change_parent_step2_search(element) {
            ...
            var url = "adminsetting/get_category_step_four";
        ...
        function upload_pic_nav() {
            ...
            if (parent > 0){
                ...
                var url = "adminsetting/upload_category_step_four";
                ...
                alert("لطفا ابتدا برند مورد نظر خود را انتخاب کنید")
            }
    ...
    <script>
        ...
        function add_nav_selected() {
            ...
            if (id_category > 0){
                ...
                var url = "adminsetting/add_nav_selected_step_four";
        ...
        function delete_nav(id_category) {
            ...
            var formData = new FormData();
            formData.append("id_category", id_category);
            var url = "adminsetting/delete_category_selected_step_four";
        ...
        function update_time_nav(id_category) {
            ...
            var formData = new FormData();
            formData.append("id_category", id_category);
            var url = "adminsetting/update_time_nav_step_four";
